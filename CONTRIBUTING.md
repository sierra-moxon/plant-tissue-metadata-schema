# Contributing to plant-tissue-metadata-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
plant-tissue-metadata-schema. These guidelines are not strict rules.
...
The plant-tissue-metadata-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the plant-tissue-metadata-schema technical leads
...
[issues]: https://github.com/sierra-moxon/plant-tissue-metadata-schema/issues/
[pulls]: https://github.com/sierra-moxon/plant-tissue-metadata-schema/pulls/
